          ...
          <Card.Body>
            ...
            {selectedCategory && (
              <div className="p-3 border rounded bg-light">
                ...
                {/* --- START: DRIVING LICENSE CHECKBOXES --- */}
                {selectedCategory === 'dl' && (
                  <>
                    ...
                    <Form.Group className="mb-3">
                      <Row>
                        <Col md={6}>
                          <Form.Check type="checkbox" name="learning_license" label="0. LEARNING LICENSE" onChange={handleServiceChange} />
                ...
                {/* --- END: DRIVING LICENSE CHECKBOXES --- */}

                {/* --- START: VEHICLE SERVICES CHECKBOXES --- */}
                ...
                {/* --- END: VEHICLE SERVICES CHECKBOXES --- */}

                <Row className="g-3 mt-3">
                  <Col md={6}>
                    <Form.Group>
                      <Form.Label><strong>Your Name *</strong></Form.Label>
                      <Form.Control value={contactName} onChange={(e) => setContactName(e.target.value)} required />
                    </Form.Group>
                  </Col>
                  <Col md={6}>
                    <Form.Group>
                      <Form.Label><strong>Contact Phone *</strong></Form.Label>
                      <Form.Control value={contactPhone} onChange={(e) => setContactPhone(e.target.value)} required />
                    </Form.Group>
                  </Col>
                </Row>
